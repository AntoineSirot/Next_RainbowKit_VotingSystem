...
export function CreatePoll() {
    ...
    useEffect(() => {
        console.log("Desc: ", description, " Duration (days, hours, minutes): ", days, hours, minutes, " Choices: ", choices);
        if (created) {
    ...
    const inputStyle = "border-pink-950 rounded bg-orange-200 px-2 py-1";

    return (
        <div className="border-pink-950 border text-pink-950 px-64 py-16 m-8 rounded-lg text-center w-120 bg-gray-50 bg-opacity-40 mx-auto max-w-3xl">
            ...
            <div className="mt-4">
                ...
                <button
                    ...
                    className="bg-orange-200 text-pink-950 font-semibold rounded-lg px-4 py-2 mr-2 hover:scale-110"
                >
                    +
                </button>
                <button
